...
class TicTacToe(Cog):
    ...
    async def tictactoe(self, ctx, member: discord.Member):
        ...
        embed = discord.Embed(color=0xF5F5F5, title=f"{ctx.author.name} wants to play tic-tac-toe with you!")
        acceptdenycomps = [
            [
        ...
        try:
            ...
            await m.edit(
                ...
                components=[
                    ...
                    Button(style=ButtonStyle.URL, label="View the creator", url="https://dsc.gg/@mansion")
                ],
            )
            return
        ...
        async def winner(team):
            ...
            board.append(Button(style=ButtonStyle.URL, label="View the creator", url="https://dsc.gg/@mansion"))
